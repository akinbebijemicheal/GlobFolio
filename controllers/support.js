                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <td align="center" bgcolor="#e9ecef">
                        ...
                        <tr>
                            ...
                            <br>
                            <p style="margin: 0;"><b>Message: ${message}</b></p>
                    ...
                    <td align="center" bgcolor="#e9ecef" style="padding: 24px;">
                        ...
                        <tr>
                            ...
                            <p style="margin: 0;">You received this email because reach out to support about their DEEPEND account.</p>
                            </td>
                        </tr>
                        <!-- end permission -->
...
exports.supportWeb = async(req, res, next)=>{
    const {name, email, subject, message} = req.body;
    try {
        const mailOptions = {
            from:  ` ${name} <${email}>`,
